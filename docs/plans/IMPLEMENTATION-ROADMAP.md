...
**Status:** **Phase 0 GATE PASSED — GO** (2026-07-01, commit 615d185). M1 in progress — detailed plan written (`docs/plans/2026-07-02-M1-detailed-plan.md`); **M1.1 storage+migration DONE (2026-07-03)**; M1.2 next. M2 detail deferred to M2 start.
